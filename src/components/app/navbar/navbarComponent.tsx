    ...
    <header className="header">
      <div className="headerContent">
        ...
        <div className="row row-center-vertical">
          <ButtonComponent id="Delete" height={38} backgroundColor={variables.colorError} textColor={variables.colorWhite} paddingLeft={15} paddingRight={15} onClick={() => {}}>
          ...
          <ButtonComponent id="New" height={38} backgroundColor={variables.colorSuccess} textColor={variables.colorWhite} paddingLeft={15} paddingRight={15} onClick={() => {}}>
            <div className="row row-center">
